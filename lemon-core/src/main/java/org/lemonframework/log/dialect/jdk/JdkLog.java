package org.lemonframework.log.dialect.jdk;
...
import org.lemonframework.log.AbstractLocationAwareLog;
...
public class JdkLog extends AbstractLocationAwareLog {
	...
	@Override
	public void log(String fqcn, org.lemonframework.log.level.Level level, Throwable t, String format, Object... arguments) {
		Level jdkLevel;
		switch (level) {
			case TRACE:
