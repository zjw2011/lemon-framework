 ...
 */
package org.lemonframework.old.cache.ehcache;
 ...
 * @since 0.0.1
 */
public class EhCache implements LocalCache, CacheEventListener {

    private String name;
    private org.ehcache.Cache<String, Object> cache;
    private CacheExpiredListener listener;

    public EhCache(String name, org.ehcache.Cache<String, Object> cache, CacheExpiredListener listener) {
        this.name = name;
        this.cache = cache;
